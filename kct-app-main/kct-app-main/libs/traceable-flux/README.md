...
`traceable-web`은 Spring WebFlux 기반 애플리케이션에서 요청 추적, 관측성 필터링, 제외 경로 관리 등을 제공하기 위한 웹 추적 설정 모듈입니다.
...
groovy
dependencies {
implementation project(":traceable-flux")
}
```
또는 별도 라이브러리로 배포된 경우:
```
groovy
dependencies {
implementation "your.group:traceable-flux:0.0.1"
}
```
